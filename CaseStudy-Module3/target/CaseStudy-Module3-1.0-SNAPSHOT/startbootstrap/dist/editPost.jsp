            ...
            <div class="container-fluid">
                ...
                <div class="page-add" style="margin: 30px;">
                    <div class="content" style="border: 1px solid; padding: 50px">
                        <h2 style="text-align: center; margin-bottom: 23px">Edit post</h2>
                        ...
                        <form action="/editPost" method="post">
                            ...
                            <div class="shortContent">
                                ...
                                <input type="text" name="shortContent" value="${posts.shortContent}">
                            </div>
                            <div class="image ">
                            ...
                            <div class="full-content">
                                ...
                                <textarea id="summernote" name="fullContent">${posts.fullContent}</textarea>
                            </div>
                            <div class="list">
                                <div class="category">
