            ...
            <div class="container-fluid">
                ...
                <div class="page-add" style="margin: 30px;">
                    <div class="content" style="border: 1px solid; padding: 50px">
                        <h2 style="text-align: center; margin-bottom: 23px">Edit Author</h2>
                        <h2 style="text-align: center; margin-bottom: 23px">${mess}</h2>
                        <form action="/editAuthor" method="post">
                            <input type="hidden" name="id" value="${listAuthor.id}">
                            <lable><b>Name Author</b></lable>
                            <input type="text" name="name" style="width: 80%; height: 14%; border-radius:5px " value="${listAuthor.name}"> <br>
