            ...
            <div class="container-fluid">
                ...
                <div class="page-add" style="margin: 30px;">
                    <div class="content" style="border: 1px solid; padding: 50px">
                        <h2 style="text-align: center; margin-bottom: 23px">Edit Category</h2>
                        ...
                        <form action="/editCategory" method="post">
                            ...
                            <input type="text" name="nameCategory" style="width: 80%; height: 14%; border-radius:5px " value="${categorys.nameCategory}"> <br>
